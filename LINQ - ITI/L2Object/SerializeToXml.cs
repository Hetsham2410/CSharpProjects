...
namespace L2Object
{
    ...
    {
        public static void SerializeToXmlDocument<T>(T obj, string fileName)
        {
            ...
            Console.WriteLine($"XML file '{fileName}' has been created successfully.");
        }
        #region ProductList
        //List<Product> ProductList = new List<Product>
        //    {
        //        new Product { ProductID = 1, ProductName = "Widget", Category = "Electronics", UnitPrice = 59.99m, UnitsInStock = 100 },
        //        new Product { ProductID = 2, ProductName = "Sneakers", Category = "Apparel", UnitPrice = 79.99m, UnitsInStock = 50 },
        ...
        //        new Product { ProductID = 14, ProductName = "Skirt", Category = "Apparel", UnitPrice = 29.99m, UnitsInStock = 120 },
        ...
        //        new Product { ProductID = 23, ProductName = "Running Shoes", Category = "Footwear", UnitPrice = 89.99m, UnitsInStock = 75 },
        ...
        //        new Product { ProductID = 29, ProductName = "Wireless Speaker", Category = "Electronics", UnitPrice = 99.99m, UnitsInStock = 25 },
        ...
        //        new Product { ProductID = 38, ProductName = "Tennis Racket", Category = "Sports", UnitPrice = 59.99m, UnitsInStock = 200 },
        ...
        //    };
        #endregion
        //SerializeToXml(ProductList, "products.xml");
